...
class ba_product_pricelist(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(ba_product_pricelist, self).__init__(cr, uid, name, context=context)
        self.pricelist=1
        self.quantity=[]
...
class report_ba_product_pricelist(osv.AbstractModel):
    _name = 'report.product.ba_report_pricelist'
    _inherit = 'report.abstract_report'
    _template = 'ba_report_pricelist.ba_report_pricelist'
    _wrapped_report_class = ba_product_pricelist
